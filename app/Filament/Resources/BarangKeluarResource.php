...
use App\Filament\Exports\BarangKeluarExport;
...
class BarangKeluarResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('bk_kode')
                ...
                Forms\Components\TextInput::make('bk_tujuan')
                    ->label('Tujuan')
                    ->maxLength(255),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('bk_kode')
                    ->label('Kode')
                    ->searchable(),
                ...
                Tables\Columns\TextColumn::make('bk_tanggal')
                    ...
                    ->date()
                    ->sortable(),
                Tables\Columns\TextColumn::make('bk_tujuan')
                    ->label('Tujuan')
                    ->searchable(),
